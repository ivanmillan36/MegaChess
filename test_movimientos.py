...
PLAYEER_TEST_MEJOR_MOVIMIENTO_2 = ( '                ' +
                                    '                ' +
                                    '                ' +
                                    '                ' +
                                    '                ' +
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (PLAYEER_TEST_MEJOR_MOVIMIENTO_2, 'white', [[15, 14], [15, 13]]),
    ] 
)
...
@pytest.mark.parametrize(
    ...
    [
        (TEST_GET_PUNTOS_POR_MOVIMIENTO, 'q', [7,1],  constantes.SCORE_REY*3000),
        ...
        (TEST_GET_PUNTOS_POR_MOVIMIENTO, 'K', [7,0],  constantes.SCORE_REINA*1000),
